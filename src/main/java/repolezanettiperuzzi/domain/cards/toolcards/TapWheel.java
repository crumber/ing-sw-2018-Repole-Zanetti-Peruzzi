...
public class TapWheel extends ToolCard {
    ...
    public ActionResult checkResult(GameBoard board, Player player, List<Integer> parameterForCard) {
        ...
        ActionResult moveResult = checkMoveTwoDiceResult(board,player,x1Start,y1Start,x1End,y1End,x2Start,y2Start,x2End,y2End);
        ...
        ActionResult roundTrackResult = checkDieOnRoundTrackResult(board,player,whichRound,whichDieOnRoundTrack);

        if(!roundTrackResult.isSuccess()){

            return roundTrackResult;
            ...
            return ActionResult.ROUND_TRACK_COLOUR_MISMATCH;
